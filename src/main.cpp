...
#ifdef USE_RELAIS
std::vector<Relay_Motor> motor(numMotors);
int timeToCompletion[numMotors] = {0, 0, 0, 0, 0, 0, 0, 0};
#endif
...
#ifdef USE_RELAIS
  motor[0].initialize(13);
  motor[1].initialize(12);
  motor[2].initialize(14);
  motor[3].initialize(27);
  motor[4].initialize(26);
  motor[5].initialize(25);
  motor[6].initialize(33);
  motor[7].initialize(32);
#endif
